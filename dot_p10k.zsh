# Generated by Powerlevel10k configuration wizard on 2025-09-17 at 13:49 CDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    wsl                     # example user-defined segment (see prompt_example function below)
  ...
  typeset -g POWERLEVEL9K_WSL_FOREGROUND=7
  typeset -g POWERLEVEL9K_WSL_BACKGROUND=33
